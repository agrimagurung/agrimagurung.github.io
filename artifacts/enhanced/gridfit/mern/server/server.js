...
import redisClient from "./db/redis.js"; // import redis from redis.js
...
app.use("/leaderboard", leaderboard); // Optimized route using Redis caching + MongoDB aggregation pipelines for performance
