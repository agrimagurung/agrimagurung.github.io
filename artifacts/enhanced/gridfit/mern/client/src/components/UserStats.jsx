...
import {
  Chart as ChartJS, // allows us to use chart components like Bar, Line, etc.
  CategoryScale, // x-axis scale for categorical data ( used for days of the week in this case)
  LinearScale, // y-axis scale for linear data (used for wattage in this case)
  BarElement, // visual element for bar charts
  Title, // plugin for displaying chart titles
  Tooltip, // plugin for showing tooltips on hover
  Legend, // plugin for displaying legends on the chart
} from "chart.js";
